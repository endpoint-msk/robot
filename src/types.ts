...
export type SpaceEvent = {
    ...
    /**
     * К ивенту приложена афиша. Сам файл лежит рядом со стейтом (см. `eventPhotoPath`),
     * а не в JSON: картинки на сотни килобайт раздули бы файл, который переписывается
